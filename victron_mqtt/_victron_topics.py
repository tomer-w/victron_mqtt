...
topics: List[TopicDescriptor] = [
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_phases",  # system attribute
        name="MultiRsSolar phases",
        unit_of_measurement=None,
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER,
    ...
    TopicDescriptor(
     ...
     TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/+/{phase}/V",
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_acout_voltage_{phase}",
        name="Voltage {phase}",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/+/{phase}/I",
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_acout_current_{phase}",
        name="Current {phase}",
        unit_of_measurement="A",
        metric_type=MetricType.CURRENT,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/+/{phase}/P",
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_acout_power_{phase}",
        name="Power {phase}",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    TopicDescriptor(
        ...
        name="MultiRsSolar MPPT {mpptnumber} state",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
        device_type=DeviceType.INVERTER,
        value_type=ValueType.ENUM,
    ...
    TopicDescriptor(
        ...
        name="MultiRsSolar PV Power Total",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER,
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_pv_yield",
        name="MultiRsSolar PV Yield",
        unit_of_measurement="kWh",
        metric_type=MetricType.ENERGY,
        metric_nature=MetricNature.CUMULATIVE,
        device_type=DeviceType.PVINVERTER,
...
#ESS Information
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_ess_acpowersetpoint",
        name="MultiRsSolar ESS AC Power Setpoint",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER,
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_inverterpowersetpoint",
        name="MultiRsSolar Inverter Power Setpoint",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER,
