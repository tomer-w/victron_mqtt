...
topics: List[TopicDescriptor] = [
    ...
    #acout 1
     TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_acout1_voltage_{phase}",
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_acout1_current_{phase}",
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_acout1_power_{phase}",
    ...
    #multirssolar mppt 1 pv topics
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_mppt1_voltage",
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_mppt1_power",
        name="MPPT1 Power",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="multirssolar_mppt1_state",
        name="MPPT1 state",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
        device_type=DeviceType.MULTI_RS_SOLAR,
