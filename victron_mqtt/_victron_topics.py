...
topics: List[TopicDescriptor] = [
    ...
    TopicDescriptor(
        topic="N/{installation_id}/vebus/{device_id}/hub4/L1/AcPowerSetpoint",
        message_type=MetricKind.NUMBER,
        short_id="vebus_ac_power_setpoint_L1",
        name="AC power setpoint L1",
        metric_type=MetricType.POWER,
        min=-10000,
        max=10000,
    ),
    TopicDescriptor(
        topic="N/{installation_id}/vebus/{device_id}/hub4/L2/AcPowerSetpoint",
        message_type=MetricKind.NUMBER,
        short_id="vebus_ac_power_setpoint_L2",
        name="AC power setpoint L2",
        metric_type=MetricType.POWER,
        min=-10000,
        max=10000,
    ),
    TopicDescriptor(
        topic="N/{installation_id}/vebus/{device_id}/hub4/L3/AcPowerSetpoint",
        message_type=MetricKind.NUMBER,
        short_id="vebus_ac_power_setpoint_L3",
        name="AC power setpoint L3",
        metric_type=MetricType.POWER,
        min=-10000,
        max=10000,
    ),
