...
topics: list[TopicDescriptor] = [
    ...
    TopicDescriptor(
        topic="N/{installation_id}/multi/{device_id}/Pv/{mppt_id}/MppOperationMode",
        message_type=MetricKind.SENSOR,
        short_id="multi_mppt_{mppt_id}_state",
        name="MPPT {mppt_id} state",
        value_type=ValueType.ENUM,
        enum=MppOperationMode,
        main_topic=True,
    ),
    TopicDescriptor(
        topic="N/{installation_id}/multi/{device_id}/Pv/{mppt_id}/P",
        message_type=MetricKind.SENSOR,
        short_id="multi_mppt_{mppt_id}_power",
        name="MPPT {mppt_id} power",
        metric_type=MetricType.POWER,
    ),
    TopicDescriptor(
        topic="N/{installation_id}/multi/{device_id}/Pv/{mppt_id}/V",
        message_type=MetricKind.SENSOR,
        short_id="multi_mppt_{mppt_id}_voltage",
        name="MPPT {mppt_id} PV voltage",
        metric_type=MetricType.VOLTAGE,
    ),
    TopicDescriptor(
        topic="$$func/multi/pv_current",
        message_type=MetricKind.SENSOR,
        short_id="multi_mppt_{mppt_id}_current",
        name="MPPT {mppt_id} current",
        metric_type=MetricType.CURRENT,
        precision=2,
        depends_on=["multi_mppt_{mppt_id}_power", "multi_mppt_{mppt_id}_voltage"],
    ),
    TopicDescriptor(
