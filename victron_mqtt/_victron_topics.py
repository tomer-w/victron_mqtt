...
topics: List[TopicDescriptor] = [
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="phases",  # system attribute
        name="Phases",
        unit_of_measurement=None,
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="acin_voltage_{phase}",
        name="Voltage on L{phase}",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="acin_power_{phase}",
        name="Power on L{phase}",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    #acout 1
     TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/1/{phase}/V",
        message_type=MetricKind.SENSOR,
        short_id="acout1_voltage_{phase}",
        name="AC Out 1 Voltage on L{phase}",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/1/{phase}/I",
        message_type=MetricKind.SENSOR,
        short_id="acout1_current_{phase}",
        name="AC Out 1 Current on L{phase}",
        unit_of_measurement="A",
        metric_type=MetricType.CURRENT,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/1/{phase}/P",
        message_type=MetricKind.SENSOR,
        short_id="acout1_power_{phase}",
        name="AC Out 1 Power on L{phase}",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    #acout 2
     TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/2/{phase}/V",
        message_type=MetricKind.SENSOR,
        short_id="acout2_voltage_{phase}",
        name="AC Out 2 Voltage on L{phase}",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/2/{phase}/I",
        message_type=MetricKind.SENSOR,
        short_id="acout2_current_{phase}",
        name="AC Out 2 Current on L{phase}",
        unit_of_measurement="A",
        metric_type=MetricType.CURRENT,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Ac/Out/2/{phase}/P",
        message_type=MetricKind.SENSOR,
        short_id="acout2_power_{phase}",
        name="AC Out 2 Power on L{phase}",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    #multirssolar mppt 1 pv topics
        TopicDescriptor(
        topic="N/+/multi/+/Pv/1/V",
        message_type=MetricKind.SENSOR,
        short_id="mppt1_voltage",
        name="MPPT1 PV Voltage",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Pv/1/P",
        message_type=MetricKind.SENSOR,
        short_id="mppt1_power",
        name="MPPT1 Power",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Pv/1/MppOperationMode",
        message_type=MetricKind.SENSOR,
        short_id="MPPT1_state",
        name="MPPT1 state",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
        device_type=DeviceType.INVERTER,
        ...
        enum=Solarchargerstate,
         ...
         #multirssolar mppt 2 pv topics
TopicDescriptor(
        topic="N/+/multi/+/Pv/2/V",
        message_type=MetricKind.SENSOR,
        short_id="mppt2_voltage",
        name="MPPT2 PV Voltage",
        unit_of_measurement="V",
        metric_type=MetricType.VOLTAGE,
        metric_nature=MetricNature.INSTANTANEOUS,
        device_type=DeviceType.INVERTER
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Pv/2/P",
        message_type=MetricKind.SENSOR,
        short_id="mppt2_power",
        name="MPPT2 Power",
        unit_of_measurement="W",
        metric_type=MetricType.POWER,
        metric_nature=MetricNature.INSTANTANEOUS,
    ...
    TopicDescriptor(
        topic="N/+/multi/+/Pv/2/MppOperationMode",
        message_type=MetricKind.SENSOR,
        short_id="MPPT2_state",
        name="MPPT2 state",
        metric_type=MetricType.NONE,
        metric_nature=MetricNature.NONE,
        device_type=DeviceType.INVERTER,
...
#ESS Information
    TopicDescriptor(
        topic="N/+/multi/+/Ess/AcPowerSetpoin",
        message_type=MetricKind.SENSOR,
        short_id="ess_acpowersetpoint",
    ...
    TopicDescriptor(
        ...
        message_type=MetricKind.SENSOR,
        short_id="inverterpowersetpoint",
