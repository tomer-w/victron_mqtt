...
class DeviceType(VictronDeviceEnum):
    ...
    PLATFORM = ("platform", "platform", "Platform", "system") # For whatever reason some system topics are under platform
...
class DESSReactiveStrategy(VictronEnum):
    ...
    SCHEDULED_CHARGE_SMOOTH_TRANSITION = (10, "scheduled_charge_smooth_transition", "Scheduled Charge Smooth Transition")
    ...
    UNSCHEDULED_CHARGE_CATCHUP_TARGETSOC = (16, "unscheduled_charge_catchup_targetsoc", "Unscheduled Charge Catch-Up Target SOC")
    ...
    SCHEDULED_DISCHARGE_SMOOTH_TRANSITION = (19, "scheduled_discharge_smooth_transition", "Scheduled Discharge Smooth Transition")
...
class ErrorCode(VictronEnum):
    ...
    INPUT_SHUTDOWN_BATTERY_VOLTAGE_TOO_HIGH = (38, "input_shutdown_battery_voltage_too_high", "Input shutdown (battery voltage too high)")
    ...
    SYNCHRONIZED_CHARGING_CONFIG_ISSUE = (66, "synchronized_charging_config_issue", "Synchronized charging config issue")
...
class ESSState(VictronEnum):
    ...
    SOC_BELOW_BATTERY_LIFE_DYNAMIC_SOC_LIMIT = (5, "soc_below_battery_life_dynamic_soc_limit", "SoC below BatteryLife dynamic SoC limit")
    SOC_BELOW_SOC_LIMIT_24_HOURS = (6, "soc_below_soc_limit_24_hours", "SoC has been below SoC limit for more than 24 hours. Charging with battery with 5amps")
    ...
    SELF_CONSUMPTION_SOC_ABOVE_MIN = (10, "self_consumption_soc_above_min", "Self consumption, SoC at or above minimum SoC")
    SELF_CONSUMPTION_SOC_BELOW_MIN = (11, "self_consumption_soc_below_min", "Self consumption, SoC is below minimum SoC")
    RECHARGE_NO_BATTERY_LIFE = (12, "recharge_no_battery_life", "Recharge, SOC dropped 5% or more below MinSOC (No BatteryLife)")

class ESSModeHub4(VictronEnum):
    """ESS Mode Enum for Hub4Control"""
    PHASE_COMPENSATION_ENABLED = (1, "phase_compensation_enabled", "Optimized mode or 'keep batteries charged' and phase compensation enabled")
    PHASE_COMPENSATION_DISABLED = (2, "phase_compensation_disabled", "Optimized mode or 'keep batteries charged' and phase compensation disabled")
    EXTERNAL_CONTROL = (3, "external_control", "External control")
...
class SolarChargerDeviceOffReason(VictronEnum):
    ...
    SWITCHED_OFF_DEVICE_MODE_REGISTER = (0x04, "switched_off_device_mode_register", "Switched off (device mode register)")
